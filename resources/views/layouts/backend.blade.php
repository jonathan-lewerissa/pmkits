      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{route('medfo')}}"><i class="fa fa-circle-o"></i> Media Informasi</a></li>
            <li><a href="{{route('dpk')}}"><i class="fa fa-circle-o"></i> Doa, Pemerhati, Konseling</a></li>
            <li><a href="{{route('pemuridan')}}"><i class="fa fa-circle-o"></i> Pemuridan</a></li>
            <li><a href="{{route('persekutuan')}}"><i class="fa fa-circle-o"></i> Persekutuan</a></li>
            <li><a href="{{route('pkmbk')}}"><i class="fa fa-circle-o"></i> PKMBK</a></li>
            <li><a href="{{route('napas')}}"><i class="fa fa-circle-o"></i> Natal-Paskah</a></li>
          </ul>
        </li>
