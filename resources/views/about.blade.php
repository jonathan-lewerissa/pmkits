		...
		<div class="contact" style="margin-bottom: 200px">
			<div class="col-md-6">
				<div class="container" style="margin-left: 50px;">
					<h3 class="w3stitle" style="text-align: left; margin-left: 250px"><span>Visi</span></h3>  
			...
			<div class="col-md-6">
				<div class="container">
					<h3 class="w3stitle" style="text-align: left; margin-left: 250px"><span>Misi</span></h3>  
					<div class="blog-agileinfo blog-agileinfo-mdl">
						<div class="agileits-w3layouts">
							<ul style="text-align: left; margin : 10px">
